...
/**
 * This is the item provider adapter for a {@link ac.soton.eventb.atomicitydecomposition.Child} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ChildItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Child_ref_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Child_ref_feature", "_UI_Child_type"),
				 AtomicitydecompositionPackage.Literals.CHILD__REF,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Child)object).getReference();
