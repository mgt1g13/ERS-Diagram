...
/**
 * This is the item provider adapter for a {@link ac.soton.eventb.atomicitydecomposition.Par} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ParItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(AtomicitydecompositionPackage.Literals.PAR__PAR_LINK);
			childrenFeatures.add(AtomicitydecompositionPackage.Literals.PAR__NEW_PARAMETER);
		}
	...
	public String getText(Object object) {
		String label = ((Par)object).getReference();
		return label == null || label.length() == 0 ?
			getString("_UI_Par_type") :
			getString("_UI_Par_type") + " " + label;
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(AtomicitydecompositionPackage.Literals.PAR__PAR_LINK,
				 AtomicitydecompositionFactory.eINSTANCE.createLeaf()));

		newChildDescriptors.add
			(createChildParameter
				(AtomicitydecompositionPackage.Literals.PAR__NEW_PARAMETER,
