 ...
 * @generated
 */
public class AtomicitydecompositionMarkerNavigationProvider extends
		AbstractModelMarkerNavigationProvider {

	/**
	 * @generated
	 */
	public static final String MARKER_TYPE = AtomicitydecompositionDiagramEditorPlugin.ID
	...
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			AtomicitydecompositionDiagramEditorUtil.selectElementsInDiagram(
