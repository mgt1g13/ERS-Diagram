...
public class AllParameterExpression  extends ParametersPropertySection{
	...
	public static final class Filter implements IFilter {
		...
		public boolean select(Object toTest) {
			return DiagramUtils.unwrap(toTest) instanceof All;
		}
	}
	
	@Override
	protected EReference getFeature() {
		return AtomicitydecompositionPackage.eINSTANCE.getAll_NewParameter();
	}
