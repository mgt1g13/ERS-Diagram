...
public class SomeParameterExpression  extends ParametersPropertySection{
	...
	public static final class Filter implements IFilter {
		...
		public boolean select(Object toTest) {
			return DiagramUtils.unwrap(toTest) instanceof Some;
		}
	}
	
	@Override
	protected EReference getFeature() {
		return AtomicitydecompositionPackage.eINSTANCE.getSome_NewParameter();
	}
