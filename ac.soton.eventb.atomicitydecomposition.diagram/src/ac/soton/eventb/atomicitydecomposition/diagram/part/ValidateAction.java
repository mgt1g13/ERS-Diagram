...
import ac.soton.eventb.atomicitydecomposition.diagram.providers.AtomicitydecompositionMarkerNavigationProvider;
import ac.soton.eventb.atomicitydecomposition.diagram.providers.AtomicitydecompositionValidationProvider;
...
public class ValidateAction extends Action {
	...
	public static void runValidation(View view) {
		try {
			if (AtomicitydecompositionDiagramEditorUtil.openDiagram(view
					.eResource())) {
	...
	public static void runValidation(DiagramEditPart diagramEditPart, View view) {
		...
		AtomicitydecompositionValidationProvider.runWithConstraints(txDomain,
				new Runnable() {
	...
	private static void validate(DiagramEditPart diagramEditPart, View view) {
		...
		if (target != null) {
			AtomicitydecompositionMarkerNavigationProvider
	...
	private static void createMarkers(IFile target, IStatus validationStatus,
		...
		AtomicitydecompositionDiagramEditorUtil.LazyElement2ViewMap element2ViewMap = new AtomicitydecompositionDiagramEditorUtil.LazyElement2ViewMap(
				diagramEditPart.getDiagramView(), collectTargetElements(
						rootStatus, new HashSet<EObject>(), allStatuses));
		for (Iterator it = allStatuses.iterator(); it.hasNext();) {
			IConstraintStatus nextStatus = (IConstraintStatus) it.next();
			View view = AtomicitydecompositionDiagramEditorUtil.findView(
	...
	private static void addMarker(EditPartViewer viewer, IFile target,
		...
		AtomicitydecompositionMarkerNavigationProvider.addMarker(target,
