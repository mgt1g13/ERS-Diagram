 ...
 * @generated
 */
public class AtomicitydecompositionInitDiagramFileAction implements
	...
	public void run(IAction action) {
		...
		Wizard wizard = new AtomicitydecompositionNewDiagramFileWizard(
				domainModelURI, diagramRoot, editingDomain);
		wizard.setWindowTitle(NLS.bind(Messages.InitDiagramFile_WizardTitle,
				FlowDiagramEditPart.MODEL_ID));
		AtomicitydecompositionDiagramEditorUtil.runWizard(getShell(), wizard,
