 ...
 * @generated
 */
public class AtomicitydecompositionDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public AtomicitydecompositionDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof AtomicitydecompositionDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((AtomicitydecompositionDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new AtomicitydecompositionDomainNavigatorItem(
