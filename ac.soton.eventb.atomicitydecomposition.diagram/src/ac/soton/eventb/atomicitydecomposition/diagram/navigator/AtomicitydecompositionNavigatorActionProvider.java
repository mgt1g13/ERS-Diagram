 ...
 * @generated
 */
public class AtomicitydecompositionNavigatorActionProvider extends
	...
	private static class OpenDiagramAction extends Action {
		...
		public final void selectionChanged(IStructuredSelection selection) {
			...
			if (selection.size() == 1) {
				...
				if (selectedElement instanceof AtomicitydecompositionNavigatorItem) {
					selectedElement = ((AtomicitydecompositionNavigatorItem) selectedElement)
							.getView();
