package ac.soton.eventb.atomicitydecomposition.diagram.expressions;
 ...
 * @generated
 */
public class AtomicitydecompositionOCLFactory {

	/**
	 * @generated
	 */
	private final AtomicitydecompositionAbstractExpression[] expressions;
	...
	protected AtomicitydecompositionOCLFactory() {
		this.expressions = new AtomicitydecompositionAbstractExpression[6];
		this.expressionBodies = new String[] {
				...
				"not self.eContainer().oclIsUndefined()", //$NON-NLS-1$
				"false", //$NON-NLS-1$
				"false", //$NON-NLS-1$
				"false", //$NON-NLS-1$
		};
	 ...
	 * @generated
	 */
	private static AtomicitydecompositionOCLFactory getInstance() {
		AtomicitydecompositionOCLFactory instance = AtomicitydecompositionDiagramEditorPlugin
				.getInstance().getAtomicitydecompositionOCLFactory();
		if (instance == null) {
			AtomicitydecompositionDiagramEditorPlugin.getInstance()
					.setAtomicitydecompositionOCLFactory(
							instance = new AtomicitydecompositionOCLFactory());
		}
		return instance;
	}
	 ...
	 * @generated
	 */
	public static AtomicitydecompositionAbstractExpression getExpression(
			int index, EClassifier context, Map<String, EClassifier> environment) {
		AtomicitydecompositionOCLFactory cached = getInstance();
	...
	private static class Expression extends
			AtomicitydecompositionAbstractExpression {
