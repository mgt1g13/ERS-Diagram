 ...
 * @generated
 */
public abstract class AtomicitydecompositionAbstractExpression {
	...
	protected void setStatus(int severity, String message, Throwable throwable) {
		String pluginID = AtomicitydecompositionDiagramEditorPlugin.ID;
	 ...
	 * @generated
	 */
	protected AtomicitydecompositionAbstractExpression(String body,
			EClassifier context) {
		myBody = body;
		myContext = context;
	}
