 ...
 * @generated
 */
public class ParParLinkExternalLabelEditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				AtomicitydecompositionVisualIDRegistry
						.getType(ac.soton.eventb.atomicitydecomposition.diagram.edit.parts.ParParLinkExternalLabelEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public ParParLinkExternalLabelEditPart(View view) {
		super(view);
	}
	...
	protected IFigure createFigurePrim() {
		return new ParParLinkExternalLabelFigure();
	}

	/**
	 * @generated
	 */
	public class ParParLinkExternalLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public ParParLinkExternalLabelFigure() {
			this.setText("");
		}
