 ...
 * @generated
 */
public class SomeNewParameterExternalLabelEditPart extends LabelEditPart
	...
	static {
		registerSnapBackPosition(
				AtomicitydecompositionVisualIDRegistry
						.getType(ac.soton.eventb.atomicitydecomposition.diagram.edit.parts.SomeNewParameterExternalLabelEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public SomeNewParameterExternalLabelEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new AtomicitydecompositionTextSelectionEditPolicy());
	...
	public IParser getParser() {
		if (parser == null) {
			parser = AtomicitydecompositionParserProvider.getParser(
	...
	protected IFigure createFigurePrim() {
		return new SomeNewParameterExternalLabelFigure();
	}

	/**
	 * @generated
	 */
	public class SomeNewParameterExternalLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public SomeNewParameterExternalLabelFigure() {
			this.setText("");
		}
