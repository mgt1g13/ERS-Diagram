 ...
 * @generated
 */
public class OneOneLinkExternalLabelEditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				AtomicitydecompositionVisualIDRegistry
						.getType(ac.soton.eventb.atomicitydecomposition.diagram.edit.parts.OneOneLinkExternalLabelEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public OneOneLinkExternalLabelEditPart(View view) {
		super(view);
	}
	...
	protected IFigure createFigurePrim() {
		return new OneOneLinkExternalLabelFigure();
	}

	/**
	 * @generated
	 */
	public class OneOneLinkExternalLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public OneOneLinkExternalLabelFigure() {
			this.setText("");
		}
