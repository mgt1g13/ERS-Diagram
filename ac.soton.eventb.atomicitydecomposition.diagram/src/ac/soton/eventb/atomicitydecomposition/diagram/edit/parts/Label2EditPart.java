 ...
 * @generated
 */
public class Label2EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	...
	/**
	 * 
	 * this is the label for SOME node
	 * @generated false
	 */
	protected String getLabelText() {
		...
		return text + Utils.mountParametersString((Some) parserElement);
	}
			...
			parser = AtomicitydecompositionParserProvider
					.getParser(
							...
							AtomicitydecompositionVisualIDRegistry
									.getType(ac.soton.eventb.atomicitydecomposition.diagram.edit.parts.Label2EditPart.VISUAL_ID));
		}
		return parser;
	}
