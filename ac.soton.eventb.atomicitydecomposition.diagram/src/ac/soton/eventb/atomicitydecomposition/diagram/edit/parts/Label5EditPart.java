 ...
 * @generated
 */
public class Label5EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public Label5EditPart(View view) {
		super(view);
	}
			...
			parser = AtomicitydecompositionParserProvider
					.getParser(
							...
							AtomicitydecompositionVisualIDRegistry
									.getType(ac.soton.eventb.atomicitydecomposition.diagram.edit.parts.Label5EditPart.VISUAL_ID));
		}
		return parser;
	}
