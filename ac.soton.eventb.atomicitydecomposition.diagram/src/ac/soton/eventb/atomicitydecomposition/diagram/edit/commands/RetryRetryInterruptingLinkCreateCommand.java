 ...
 * @generated
 */
public class RetryRetryInterruptingLinkCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public RetryRetryInterruptingLinkCreateCommand(
	...
	public boolean canExecute() {
		...
		return AtomicitydecompositionBaseItemSemanticEditPolicy
				.getLinkConstraints().canCreateRetryRetryInterruptingLink_4022(
						getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().setRetryInterruptingLink(getTarget());
		}
