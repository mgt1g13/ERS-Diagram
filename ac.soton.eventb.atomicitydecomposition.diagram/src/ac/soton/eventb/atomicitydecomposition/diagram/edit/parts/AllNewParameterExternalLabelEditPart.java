 ...
 * @generated
 */
public class AllNewParameterExternalLabelEditPart extends LabelEditPart
	...
	static {
		registerSnapBackPosition(
				AtomicitydecompositionVisualIDRegistry
						.getType(ac.soton.eventb.atomicitydecomposition.diagram.edit.parts.AllNewParameterExternalLabelEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public AllNewParameterExternalLabelEditPart(View view) {
		super(view);
	}
	...
	protected IFigure createFigurePrim() {
		return new AllNewParameterExternalLabelFigure();
	}

	/**
	 * @generated
	 */
	public class AllNewParameterExternalLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public AllNewParameterExternalLabelFigure() {
			this.setText("");
		}
