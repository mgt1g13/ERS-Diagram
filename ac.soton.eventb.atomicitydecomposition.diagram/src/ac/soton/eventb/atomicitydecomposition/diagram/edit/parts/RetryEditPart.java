...
import ac.soton.eventb.atomicitydecomposition.diagram.edit.policies.RetryCanonicalEditPolicy;
import ac.soton.eventb.atomicitydecomposition.diagram.edit.policies.RetryItemSemanticEditPolicy;
import ac.soton.eventb.atomicitydecomposition.diagram.part.AtomicitydecompositionVisualIDRegistry;

/**
 * @generated
 */
public class RetryEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public RetryEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new RetryItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new RetryCanonicalEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new RetryFigure();
	}

	/**
	 * @generated
	 */
	public RetryFigure getPrimaryShape() {
		return (RetryFigure) primaryShape;
	}
	 ...
	 * @generated
	 */
	public class RetryFigure extends Ellipse {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureRetryLabelName;
		...
		private void createContents() {
			...
			fFigureRetryLabelName = new WrappingLabel();

			fFigureRetryLabelName.setText("X*");
			fFigureRetryLabelName.setAlignment(PositionConstants.CENTER);

			this.add(fFigureRetryLabelName);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureRetryLabelName() {
			return fFigureRetryLabelName;
		}
