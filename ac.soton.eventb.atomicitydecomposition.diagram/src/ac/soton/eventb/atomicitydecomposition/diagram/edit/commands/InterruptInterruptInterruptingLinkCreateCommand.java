 ...
 * @generated
 */
public class InterruptInterruptInterruptingLinkCreateCommand extends
		EditElementCommand {
	 ...
	 * @generated
	 */
	public InterruptInterruptInterruptingLinkCreateCommand(
	...
	public boolean canExecute() {
		...
		if (source != null && false == source instanceof Interrupt) {
			return false;
		}
		...
		return AtomicitydecompositionBaseItemSemanticEditPolicy
				.getLinkConstraints()
				.canCreateInterruptInterruptInterruptingLink_4020(getSource(),
						getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().setInterruptInterruptingLink(getTarget());
		}
