 ...
 * @generated
 */
public class SomeSomeLinkCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public SomeSomeLinkCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return AtomicitydecompositionBaseItemSemanticEditPolicy
				.getLinkConstraints().canCreateSomeSomeLink_4006(getSource(),
						getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().setSomeLink(getTarget());
		}
