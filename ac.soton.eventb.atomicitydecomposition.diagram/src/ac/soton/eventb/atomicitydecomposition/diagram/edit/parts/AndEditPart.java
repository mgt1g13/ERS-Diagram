...
import ac.soton.eventb.atomicitydecomposition.diagram.edit.policies.AndCanonicalEditPolicy;
import ac.soton.eventb.atomicitydecomposition.diagram.edit.policies.AndItemSemanticEditPolicy;
 ...
 * @generated
 */
public class AndEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public class AndFigure extends RoundedRectangle {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureAndLabelFigure;
		...
		private void createContents() {
			...
			fFigureAndLabelFigure = new WrappingLabel();

			fFigureAndLabelFigure.setText("and");

			this.add(fFigureAndLabelFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureAndLabelFigure() {
			return fFigureAndLabelFigure;
		}
