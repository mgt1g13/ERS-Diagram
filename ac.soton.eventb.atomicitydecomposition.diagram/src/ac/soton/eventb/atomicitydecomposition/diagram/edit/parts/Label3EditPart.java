 ...
 * @generated
 */
public class Label3EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
			...
			parser = AtomicitydecompositionParserProvider
					.getParser(
							...
							AtomicitydecompositionVisualIDRegistry
									.getType(ac.soton.eventb.atomicitydecomposition.diagram.edit.parts.Label3EditPart.VISUAL_ID));
		}
		return parser;
	}
