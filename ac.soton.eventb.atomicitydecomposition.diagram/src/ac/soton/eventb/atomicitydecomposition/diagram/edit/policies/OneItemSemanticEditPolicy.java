 ...
 * @generated
 */
public class OneItemSemanticEditPolicy extends
		AtomicitydecompositionBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public OneItemSemanticEditPolicy() {
		super(AtomicitydecompositionElementTypes.One_2008);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (AtomicitydecompositionVisualIDRegistry
					.getVisualID(outgoingLink) == OneOneLinkEditPart.VISUAL_ID) {
				DestroyReferenceRequest r = new DestroyReferenceRequest(
			...
			if (AtomicitydecompositionVisualIDRegistry
					.getVisualID(outgoingLink) == OneNewParameterEditPart.VISUAL_ID) {
				DestroyReferenceRequest r = new DestroyReferenceRequest(
						outgoingLink.getSource().getElement(), null,
						outgoingLink.getTarget().getElement(), false);
				cmd.add(new DestroyReferenceCommand(r) {
