 ...
 * @generated
 */
public class XorXorLinkCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public XorXorLinkCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		if (source != null && false == source instanceof Xor) {
			return false;
		}
		...
		return AtomicitydecompositionBaseItemSemanticEditPolicy
				.getLinkConstraints().canCreateXorXorLink_4009(getSource(),
						getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getXorLink().add(getTarget());
		}
