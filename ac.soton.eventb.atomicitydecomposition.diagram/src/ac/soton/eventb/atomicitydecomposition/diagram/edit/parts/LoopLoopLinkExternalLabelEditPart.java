 ...
 * @generated
 */
public class LoopLoopLinkExternalLabelEditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				AtomicitydecompositionVisualIDRegistry
						.getType(ac.soton.eventb.atomicitydecomposition.diagram.edit.parts.LoopLoopLinkExternalLabelEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public LoopLoopLinkExternalLabelEditPart(View view) {
		super(view);
	}
	...
	protected IFigure createFigurePrim() {
		return new LoopLoopLinkExternalLabelFigure();
	}

	/**
	 * @generated
	 */
	public class LoopLoopLinkExternalLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public LoopLoopLinkExternalLabelFigure() {
			this.setText("");
		}
