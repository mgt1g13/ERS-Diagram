 ...
 * @generated
 */
public class Label6EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public Label6EditPart(View view) {
		super(view);
	}
			...
			parser = AtomicitydecompositionParserProvider
					.getParser(
							...
							AtomicitydecompositionVisualIDRegistry
									.getType(ac.soton.eventb.atomicitydecomposition.diagram.edit.parts.Label6EditPart.VISUAL_ID));
		}
		return parser;
	}
