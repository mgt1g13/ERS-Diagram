 ...
 * @generated
 */
public class ParParLinkCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ParParLinkCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		if (source != null && false == source instanceof Par) {
			return false;
		}
		...
		return AtomicitydecompositionBaseItemSemanticEditPolicy
				.getLinkConstraints().canCreateParParLink_4012(getSource(),
						getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().setParLink(getTarget());
		}
