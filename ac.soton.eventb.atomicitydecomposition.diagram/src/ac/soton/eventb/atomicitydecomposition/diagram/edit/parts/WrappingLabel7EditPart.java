 ...
 * @generated
 */
public class WrappingLabel7EditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				AtomicitydecompositionVisualIDRegistry
						.getType(ac.soton.eventb.atomicitydecomposition.diagram.edit.parts.WrappingLabel7EditPart.VISUAL_ID),
				new Point(0, 40));
	}
