 ...
 * @generated
 */
public class ParReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ParReorientCommand(ReorientRelationshipRequest request) {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof Par) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		Leaf target = getLink().getParLink();
		return AtomicitydecompositionBaseItemSemanticEditPolicy
				.getLinkConstraints().canExistPar_4018(getLink(),
						getNewSource(), target);
	}
	...
	protected boolean canReorientTarget() {
		...
		return AtomicitydecompositionBaseItemSemanticEditPolicy
				.getLinkConstraints().canExistPar_4018(getLink(), source,
						getNewTarget());
	}
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getLink().setParLink(getNewTarget());
		return CommandResult.newOKCommandResult(getLink());
	}
	 ...
	 * @generated
	 */
	protected Par getLink() {
		return (Par) getElementToEdit();
	}
