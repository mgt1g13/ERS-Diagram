 ...
 * @generated
 */
public class RetryRetryInterruptingLinkReorientCommand extends
		EditElementCommand {
	 ...
	 * @generated
	 */
	public RetryRetryInterruptingLinkReorientCommand(
	...
	protected boolean canReorientSource() {
		...
		return AtomicitydecompositionBaseItemSemanticEditPolicy
				.getLinkConstraints().canExistRetryRetryInterruptingLink_4022(
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().setRetryInterruptingLink(null);
		getNewSource().setRetryInterruptingLink(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().setRetryInterruptingLink(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
