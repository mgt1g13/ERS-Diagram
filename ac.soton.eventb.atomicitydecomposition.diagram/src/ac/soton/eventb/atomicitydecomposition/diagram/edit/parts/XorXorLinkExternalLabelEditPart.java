 ...
 * @generated
 */
public class XorXorLinkExternalLabelEditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				AtomicitydecompositionVisualIDRegistry
						.getType(ac.soton.eventb.atomicitydecomposition.diagram.edit.parts.XorXorLinkExternalLabelEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public XorXorLinkExternalLabelEditPart(View view) {
		super(view);
	}
	...
	protected IFigure createFigurePrim() {
		return new XorXorLinkExternalLabelFigure();
	}

	/**
	 * @generated
	 */
	public class XorXorLinkExternalLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public XorXorLinkExternalLabelFigure() {
			this.setText("");
		}
