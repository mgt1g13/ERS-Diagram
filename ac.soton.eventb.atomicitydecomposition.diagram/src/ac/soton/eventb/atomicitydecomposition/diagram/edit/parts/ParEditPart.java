...
import ac.soton.eventb.atomicitydecomposition.diagram.edit.policies.ParCanonicalEditPolicy;
import ac.soton.eventb.atomicitydecomposition.diagram.edit.policies.ParItemSemanticEditPolicy;
 ...
 * @generated
 */
public class ParEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ParItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new ParCanonicalEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new ParFigure();
	}

	/**
	 * @generated
	 */
	public ParFigure getPrimaryShape() {
		return (ParFigure) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof Label6EditPart) {
			((Label6EditPart) childEditPart).setLabel(getPrimaryShape()
					.getFigureParLabelName());
			return true;
		}
		return false;
	}
	...
	public List<IElementType> getMATypesForTarget(IElementType relationshipType) {
		LinkedList<IElementType> types = new LinkedList<IElementType>();
		if (relationshipType == AtomicitydecompositionElementTypes.ParParLink_4012) {
	 ...
	 * @generated
	 */
	public class ParFigure extends Ellipse {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureParLabelName;
		...
		private void createContents() {
			...
			fFigureParLabelName = new WrappingLabel();

			fFigureParLabelName.setText("par");

			fFigureParLabelName.setAlignment(PositionConstants.CENTER);

			this.add(fFigureParLabelName);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureParLabelName() {
			return fFigureParLabelName;
		}
