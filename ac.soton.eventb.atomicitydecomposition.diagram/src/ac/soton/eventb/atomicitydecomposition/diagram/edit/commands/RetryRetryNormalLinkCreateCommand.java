 ...
 * @generated
 */
public class RetryRetryNormalLinkCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public RetryRetryNormalLinkCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		if (source != null && false == source instanceof Retry) {
			return false;
		}
		...
		return AtomicitydecompositionBaseItemSemanticEditPolicy
				.getLinkConstraints().canCreateRetryRetryNormalLink_4021(
						getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().setRetryNormalLink(getTarget());
		}
