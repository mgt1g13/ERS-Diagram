 ...
 * @generated
 */
public class InterruptItemSemanticEditPolicy extends
		AtomicitydecompositionBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public InterruptItemSemanticEditPolicy() {
		super(AtomicitydecompositionElementTypes.Interrupt_2012);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (AtomicitydecompositionVisualIDRegistry
					.getVisualID(outgoingLink) == InterruptInterruptNormalLinkEditPart.VISUAL_ID) {
				DestroyReferenceRequest r = new DestroyReferenceRequest(
			...
			if (AtomicitydecompositionVisualIDRegistry
					.getVisualID(outgoingLink) == InterruptInterruptInterruptingLinkEditPart.VISUAL_ID) {
				DestroyReferenceRequest r = new DestroyReferenceRequest(
						outgoingLink.getSource().getElement(), null,
						outgoingLink.getTarget().getElement(), false);
				cmd.add(new DestroyReferenceCommand(r) {
