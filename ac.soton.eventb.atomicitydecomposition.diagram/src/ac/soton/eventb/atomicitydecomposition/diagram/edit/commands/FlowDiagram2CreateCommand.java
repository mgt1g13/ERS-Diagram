 ...
 * @generated
 */
public class FlowDiagram2CreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public FlowDiagram2CreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		if (target != null && false == target instanceof Child) {
			return false;
		}
		if (getSource() == null) {
		...
		return AtomicitydecompositionBaseItemSemanticEditPolicy
				.getLinkConstraints().canCreateFlowDiagram_4015(getSource(),
						getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		FlowDiagram newElement = AtomicitydecompositionFactory.eINSTANCE
				.createFlowDiagram();
		getSource().getDecompose().add(newElement);
		newElement.getRefine().add(getTarget());
	 ...
	 * @generated
	 */
	protected void doConfigure(FlowDiagram newElement,
