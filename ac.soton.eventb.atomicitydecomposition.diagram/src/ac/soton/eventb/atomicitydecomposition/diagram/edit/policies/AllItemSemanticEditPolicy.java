...
import ac.soton.eventb.atomicitydecomposition.diagram.edit.commands.AllNewParameterCreateCommand;
import ac.soton.eventb.atomicitydecomposition.diagram.edit.commands.AllNewParameterReorientCommand;
 ...
 * @generated
 */
public class AllItemSemanticEditPolicy extends
		AtomicitydecompositionBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public AllItemSemanticEditPolicy() {
		super(AtomicitydecompositionElementTypes.All_2004);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (AtomicitydecompositionVisualIDRegistry
					.getVisualID(outgoingLink) == AllAllLinkEditPart.VISUAL_ID) {
				DestroyReferenceRequest r = new DestroyReferenceRequest(
			...
			if (AtomicitydecompositionVisualIDRegistry
					.getVisualID(outgoingLink) == AllNewParameterEditPart.VISUAL_ID) {
				DestroyReferenceRequest r = new DestroyReferenceRequest(
						outgoingLink.getSource().getElement(), null,
						outgoingLink.getTarget().getElement(), false);
				cmd.add(new DestroyReferenceCommand(r) {
	...
	protected Command getStartCreateRelationshipCommand(
		...
		if (AtomicitydecompositionElementTypes.AllNewParameter_4005 == req
				.getElementType()) {
			return getGEFWrapper(new AllNewParameterCreateCommand(req,
					req.getSource(), req.getTarget()));
		}
	...
	protected Command getReorientReferenceRelationshipCommand(
		...
		case AllNewParameterEditPart.VISUAL_ID:
			return getGEFWrapper(new AllNewParameterReorientCommand(req));
