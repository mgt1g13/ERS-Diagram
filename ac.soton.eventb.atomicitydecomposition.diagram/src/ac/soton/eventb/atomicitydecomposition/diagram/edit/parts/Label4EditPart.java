 ...
 * @generated
 */
public class Label4EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
			...
			parser = AtomicitydecompositionParserProvider
					.getParser(
							...
							AtomicitydecompositionVisualIDRegistry
									.getType(ac.soton.eventb.atomicitydecomposition.diagram.edit.parts.Label4EditPart.VISUAL_ID));
		}
		return parser;
	}
