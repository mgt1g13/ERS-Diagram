...
import ac.soton.eventb.atomicitydecomposition.diagram.part.AtomicitydecompositionDiagramUpdater;
import ac.soton.eventb.atomicitydecomposition.diagram.part.AtomicitydecompositionLinkDescriptor;
import ac.soton.eventb.atomicitydecomposition.diagram.part.AtomicitydecompositionNodeDescriptor;
import ac.soton.eventb.atomicitydecomposition.diagram.part.AtomicitydecompositionVisualIDRegistry;

/**
 * @generated
 */
public class FlowDiagramCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return AtomicitydecompositionPackage.eINSTANCE.getFlowDiagram_Refine();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<AtomicitydecompositionNodeDescriptor> childDescriptors = AtomicitydecompositionDiagramUpdater
				.getFlowDiagram_1000SemanticChildren(viewObject);
		for (AtomicitydecompositionNodeDescriptor d : childDescriptors) {
	...
	private boolean isMyDiagramElement(View view) {
		int visualID = AtomicitydecompositionVisualIDRegistry.getVisualID(view);
		switch (visualID) {
	...
	protected void refreshSemantic() {
		...
		List<AtomicitydecompositionNodeDescriptor> childDescriptors = AtomicitydecompositionDiagramUpdater
				.getFlowDiagram_1000SemanticChildren((View) getHost()
						.getModel());
		...
		HashMap<AtomicitydecompositionNodeDescriptor, LinkedList<View>> potentialViews = new HashMap<AtomicitydecompositionNodeDescriptor, LinkedList<View>>();
		//
		// iteration happens over list of desired semantic elements, trying to find best matching View, while original CEP
		// iterates views, potentially losing view (size/bounds) information - i.e. if there are few views to reference same EObject, only last one 
		// to answer isOrphaned == true will be used for the domain element representation, see #cleanCanonicalSemanticChildren()
		for (Iterator<AtomicitydecompositionNodeDescriptor> descriptorsIterator = childDescriptors
				.iterator(); descriptorsIterator.hasNext();) {
			AtomicitydecompositionNodeDescriptor next = descriptorsIterator
					.next();
			String hint = AtomicitydecompositionVisualIDRegistry.getType(next
					.getVisualID());
		...
		for (AtomicitydecompositionNodeDescriptor next : childDescriptors) {
			String hint = AtomicitydecompositionVisualIDRegistry.getType(next
					.getVisualID());
	...
	private Collection<IAdaptable> refreshConnections() {
		...
		Collection<AtomicitydecompositionLinkDescriptor> linkDescriptors = collectAllLinks(
				getDiagram(), domain2NotationMap);
		Collection existingLinks = new LinkedList(getDiagram().getEdges());
		for (Iterator linksIterator = existingLinks.iterator(); linksIterator
				.hasNext();) {
			Edge nextDiagramLink = (Edge) linksIterator.next();
			int diagramLinkVisualID = AtomicitydecompositionVisualIDRegistry
			...
			for (Iterator<AtomicitydecompositionLinkDescriptor> linkDescriptorsIterator = linkDescriptors
					.iterator(); linkDescriptorsIterator.hasNext();) {
				AtomicitydecompositionLinkDescriptor nextLinkDescriptor = linkDescriptorsIterator
						.next();
	 ...
	 * @generated
	 */
	private Collection<AtomicitydecompositionLinkDescriptor> collectAllLinks(
		...
		case FlowDiagramEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(AtomicitydecompositionDiagramUpdater
						.getFlowDiagram_1000ContainedLinks(view));
			}
		...
		case LeafEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(AtomicitydecompositionDiagramUpdater
						.getLeaf_2001ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case AndEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(AtomicitydecompositionDiagramUpdater
						.getAnd_2002ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case LoopEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(AtomicitydecompositionDiagramUpdater
						.getLoop_2003ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case AllEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(AtomicitydecompositionDiagramUpdater
						.getAll_2004ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case SomeEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(AtomicitydecompositionDiagramUpdater
						.getSome_2005ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		...
		case XorEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(AtomicitydecompositionDiagramUpdater
						.getXor_2007ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case OneEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(AtomicitydecompositionDiagramUpdater
						.getOne_2008ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case ParEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(AtomicitydecompositionDiagramUpdater
						.getPar_2009ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case Leaf2EditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(AtomicitydecompositionDiagramUpdater
						.getLeaf_2010ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case FlowDiagram2EditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(AtomicitydecompositionDiagramUpdater
						.getFlowDiagram_2011ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case InterruptEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(AtomicitydecompositionDiagramUpdater
						.getInterrupt_2012ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case RetryEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(AtomicitydecompositionDiagramUpdater
						.getRetry_2013ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case FlowDiagram3EditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(AtomicitydecompositionDiagramUpdater
						.getFlowDiagram_4015ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		...
		case Par2EditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(AtomicitydecompositionDiagramUpdater
						.getPar_4018ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
	...
	private Collection<IAdaptable> createConnections(
			Collection<AtomicitydecompositionLinkDescriptor> linkDescriptors,
			Domain2Notation domain2NotationMap) {
		LinkedList<IAdaptable> adapters = new LinkedList<IAdaptable>();
		for (AtomicitydecompositionLinkDescriptor nextLinkDescriptor : linkDescriptors) {
	...
	protected final EditPart getHintedEditPart(EObject domainModelElement,
		...
		View view = (View) domain2NotationMap.getHinted(domainModelElement,
				AtomicitydecompositionVisualIDRegistry.getType(hintVisualId));
		if (view != null) {
			return (EditPart) getHost().getViewer().getEditPartRegistry()
					.get(view);
		}
