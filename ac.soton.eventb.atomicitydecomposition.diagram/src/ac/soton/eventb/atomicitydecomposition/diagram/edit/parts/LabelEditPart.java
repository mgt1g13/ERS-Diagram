 ...
 * @generated
 */
public class LabelEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
			...
			parser = AtomicitydecompositionParserProvider
					.getParser(
							...
							AtomicitydecompositionVisualIDRegistry
									.getType(ac.soton.eventb.atomicitydecomposition.diagram.edit.parts.LabelEditPart.VISUAL_ID));
		}
		return parser;
	}
