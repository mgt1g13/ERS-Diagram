 ...
 * @generated
 */
public class OneOneLinkCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public OneOneLinkCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return AtomicitydecompositionBaseItemSemanticEditPolicy
				.getLinkConstraints().canCreateOneOneLink_4010(getSource(),
						getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().setOneLink(getTarget());
		}
