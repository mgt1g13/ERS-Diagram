 ...
 * @generated
 */
public class SomeEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new SomeItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new SomeCanonicalEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new SomeFigure();
	}

	/**
	 * @generated
	 */
	public SomeFigure getPrimaryShape() {
		return (SomeFigure) primaryShape;
	}
