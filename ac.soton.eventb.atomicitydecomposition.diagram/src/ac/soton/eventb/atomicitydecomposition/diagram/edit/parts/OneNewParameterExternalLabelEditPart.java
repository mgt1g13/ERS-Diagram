 ...
 * @generated
 */
public class OneNewParameterExternalLabelEditPart extends LabelEditPart
	...
	static {
		registerSnapBackPosition(
				AtomicitydecompositionVisualIDRegistry
						.getType(ac.soton.eventb.atomicitydecomposition.diagram.edit.parts.OneNewParameterExternalLabelEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public OneNewParameterExternalLabelEditPart(View view) {
		super(view);
	}
	...
	protected IFigure createFigurePrim() {
		return new OneNewParameterExternalLabelFigure();
	}

	/**
	 * @generated
	 */
	public class OneNewParameterExternalLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public OneNewParameterExternalLabelFigure() {
			this.setText("");
		}
