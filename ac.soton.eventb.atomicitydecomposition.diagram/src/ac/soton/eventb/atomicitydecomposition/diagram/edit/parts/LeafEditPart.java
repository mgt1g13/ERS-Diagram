...
import ac.soton.eventb.atomicitydecomposition.diagram.edit.policies.LeafCanonicalEditPolicy;
import ac.soton.eventb.atomicitydecomposition.diagram.edit.policies.LeafItemSemanticEditPolicy;
 ...
 * @generated
 */
public class LeafEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new LeafItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new LeafCanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof LeafNameEditPart) {
			((LeafNameEditPart) childEditPart).setLabel(getPrimaryShape()
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof ac.soton.eventb.atomicitydecomposition.diagram.edit.parts.LeafEditPart) {
			types.add(AtomicitydecompositionElementTypes.FlowDiagram_4015);
		}
