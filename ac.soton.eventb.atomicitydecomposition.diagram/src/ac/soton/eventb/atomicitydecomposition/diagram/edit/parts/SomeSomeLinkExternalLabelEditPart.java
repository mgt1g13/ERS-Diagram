 ...
 * @generated
 */
public class SomeSomeLinkExternalLabelEditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				AtomicitydecompositionVisualIDRegistry
						.getType(ac.soton.eventb.atomicitydecomposition.diagram.edit.parts.SomeSomeLinkExternalLabelEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public SomeSomeLinkExternalLabelEditPart(View view) {
		super(view);
	}
	...
	protected IFigure createFigurePrim() {
		return new SomeSomeLinkExternalLabelFigure();
	}

	/**
	 * @generated
	 */
	public class SomeSomeLinkExternalLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public SomeSomeLinkExternalLabelFigure() {
			this.setText("");
		}
