 ...
 * @generated
 */
public class OrOrLinkExternalLabelEditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				AtomicitydecompositionVisualIDRegistry
						.getType(ac.soton.eventb.atomicitydecomposition.diagram.edit.parts.OrOrLinkExternalLabelEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public OrOrLinkExternalLabelEditPart(View view) {
		super(view);
	}
	...
	protected IFigure createFigurePrim() {
		return new OrOrLinkExternalLabelFigure();
	}

	/**
	 * @generated
	 */
	public class OrOrLinkExternalLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public OrOrLinkExternalLabelFigure() {
			this.setText("");
		}
