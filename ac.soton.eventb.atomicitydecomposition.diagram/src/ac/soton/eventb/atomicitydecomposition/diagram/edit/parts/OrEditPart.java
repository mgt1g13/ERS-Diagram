...
import ac.soton.eventb.atomicitydecomposition.diagram.edit.policies.OrCanonicalEditPolicy;
import ac.soton.eventb.atomicitydecomposition.diagram.edit.policies.OrItemSemanticEditPolicy;
...
public class OrEditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof Label3EditPart) {
			((Label3EditPart) childEditPart).setLabel(getPrimaryShape()
					.getFigureOrLabelName());
			return true;
		}
		return false;
	}
	 ...
	 * @generated
	 */
	public class OrFigure extends Ellipse {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureOrLabelName;
		...
		private void createContents() {
			...
			fFigureOrLabelName = new WrappingLabel();

			fFigureOrLabelName.setText("or");

			fFigureOrLabelName.setAlignment(PositionConstants.CENTER);

			this.add(fFigureOrLabelName);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureOrLabelName() {
			return fFigureOrLabelName;
		}
