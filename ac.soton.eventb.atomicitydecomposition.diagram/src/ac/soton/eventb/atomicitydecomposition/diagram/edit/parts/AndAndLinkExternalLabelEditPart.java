 ...
 * @generated
 */
public class AndAndLinkExternalLabelEditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				AtomicitydecompositionVisualIDRegistry
						.getType(ac.soton.eventb.atomicitydecomposition.diagram.edit.parts.AndAndLinkExternalLabelEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public AndAndLinkExternalLabelEditPart(View view) {
		super(view);
	}
	...
	protected IFigure createFigurePrim() {
		return new AndAndLinkExternalLabelFigure();
	}

	/**
	 * @generated
	 */
	public class AndAndLinkExternalLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public AndAndLinkExternalLabelFigure() {
			this.setText("");
		}
