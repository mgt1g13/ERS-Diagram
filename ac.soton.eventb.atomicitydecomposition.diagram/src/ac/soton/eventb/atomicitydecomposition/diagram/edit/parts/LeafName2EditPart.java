 ...
 * @generated
 */
public class LeafName2EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public LeafName2EditPart(View view) {
		super(view);
	}
	...
	protected Image getLabelIcon() {
		...
		return AtomicitydecompositionElementTypes.getImage(parserElement
				.eClass());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = AtomicitydecompositionParserProvider
					.getParser(
							AtomicitydecompositionElementTypes.Leaf_2010,
							getParserElement(),
							AtomicitydecompositionVisualIDRegistry
									.getType(ac.soton.eventb.atomicitydecomposition.diagram.edit.parts.LeafName2EditPart.VISUAL_ID));
		}
		return parser;
	}
