 ...
 * @generated
 */
public class AllAllLinkExternalLabelEditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				AtomicitydecompositionVisualIDRegistry
						.getType(ac.soton.eventb.atomicitydecomposition.diagram.edit.parts.AllAllLinkExternalLabelEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public AllAllLinkExternalLabelEditPart(View view) {
		super(view);
	}
	...
	protected IFigure createFigurePrim() {
		return new AllAllLinkExternalLabelFigure();
	}

	/**
	 * @generated
	 */
	public class AllAllLinkExternalLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public AllAllLinkExternalLabelFigure() {
			this.setText("");
		}
