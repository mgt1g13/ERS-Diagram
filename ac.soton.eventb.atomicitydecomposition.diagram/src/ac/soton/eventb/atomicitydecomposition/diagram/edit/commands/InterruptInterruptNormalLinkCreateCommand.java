 ...
 * @generated
 */
public class InterruptInterruptNormalLinkCreateCommand extends
		EditElementCommand {
	 ...
	 * @generated
	 */
	public InterruptInterruptNormalLinkCreateCommand(
	...
	public boolean canExecute() {
		...
		return AtomicitydecompositionBaseItemSemanticEditPolicy
				.getLinkConstraints()
				.canCreateInterruptInterruptNormalLink_4019(getSource(),
						getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().setInterruptNormalLink(getTarget());
		}
