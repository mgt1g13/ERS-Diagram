...
import ac.soton.eventb.atomicitydecomposition.diagram.edit.commands.SomeNewParameterCreateCommand;
import ac.soton.eventb.atomicitydecomposition.diagram.edit.commands.SomeNewParameterReorientCommand;
 ...
 * @generated
 */
public class SomeItemSemanticEditPolicy extends
		AtomicitydecompositionBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public SomeItemSemanticEditPolicy() {
		super(AtomicitydecompositionElementTypes.Some_2005);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (AtomicitydecompositionVisualIDRegistry
					.getVisualID(outgoingLink) == SomeSomeLinkEditPart.VISUAL_ID) {
				DestroyReferenceRequest r = new DestroyReferenceRequest(
			...
			if (AtomicitydecompositionVisualIDRegistry
					.getVisualID(outgoingLink) == SomeNewParameterEditPart.VISUAL_ID) {
				DestroyReferenceRequest r = new DestroyReferenceRequest(
						outgoingLink.getSource().getElement(), null,
						outgoingLink.getTarget().getElement(), false);
				cmd.add(new DestroyReferenceCommand(r) {
	...
	protected Command getStartCreateRelationshipCommand(
		...
		if (AtomicitydecompositionElementTypes.SomeNewParameter_4007 == req
				.getElementType()) {
			return getGEFWrapper(new SomeNewParameterCreateCommand(req,
					req.getSource(), req.getTarget()));
		}
	...
	protected Command getReorientReferenceRelationshipCommand(
		...
		case SomeNewParameterEditPart.VISUAL_ID:
			return getGEFWrapper(new SomeNewParameterReorientCommand(req));
