 ...
 * @generated
 */
public class OrOrLinkCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public OrOrLinkCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		if (source != null && false == source instanceof Or) {
			return false;
		}
		...
		return AtomicitydecompositionBaseItemSemanticEditPolicy
				.getLinkConstraints().canCreateOrOrLink_4008(getSource(),
						getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getOrLink().add(getTarget());
		}
