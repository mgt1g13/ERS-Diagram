 ...
 * @generated
 */
public class LeafNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public LeafNameEditPart(View view) {
		super(view);
	}
			...
			parser = AtomicitydecompositionParserProvider
					.getParser(
							...
							AtomicitydecompositionVisualIDRegistry
									.getType(ac.soton.eventb.atomicitydecomposition.diagram.edit.parts.LeafNameEditPart.VISUAL_ID));
		}
		return parser;
	}
