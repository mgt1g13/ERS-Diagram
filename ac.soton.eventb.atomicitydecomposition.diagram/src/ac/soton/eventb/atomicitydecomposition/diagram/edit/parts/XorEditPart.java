...
import ac.soton.eventb.atomicitydecomposition.diagram.edit.policies.XorCanonicalEditPolicy;
import ac.soton.eventb.atomicitydecomposition.diagram.edit.policies.XorItemSemanticEditPolicy;
 ...
 * @generated
 */
public class XorEditPart extends ShapeNodeEditPart {
	...
	protected IFigure createNodeShape() {
		return primaryShape = new XorFigure();
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof Label4EditPart) {
			((Label4EditPart) childEditPart).setLabel(getPrimaryShape()
					.getFigureXorLabelName());
			return true;
		}
		return false;
	}
	...
	public class XorFigure extends Ellipse {
		 ...
		 * @generated
		 */
		private WrappingLabel fFigureXorLabelName;
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureXorLabelName() {
			return fFigureXorLabelName;
		}
