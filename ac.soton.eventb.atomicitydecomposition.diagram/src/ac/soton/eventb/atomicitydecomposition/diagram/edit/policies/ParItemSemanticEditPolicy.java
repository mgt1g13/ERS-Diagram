 ...
 * @generated
 */
public class ParItemSemanticEditPolicy extends
		AtomicitydecompositionBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public ParItemSemanticEditPolicy() {
		super(AtomicitydecompositionElementTypes.Par_2009);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (AtomicitydecompositionVisualIDRegistry
					.getVisualID(outgoingLink) == ParParLinkEditPart.VISUAL_ID) {
				DestroyReferenceRequest r = new DestroyReferenceRequest(
